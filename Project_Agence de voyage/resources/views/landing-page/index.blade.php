                        ...
                        <div class="row">
                            <div class="col-md-12 nav-link-wrap">
                                <div class="nav nav-pills text-center" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                    <a class="nav-link active mr-md-1" id="v-pills-1-tab" data-toggle="pill" href="#v-pills-1" role="tab" aria-controls="v-pills-1" aria-selected="true">Search Destination</a>
                                </div>
                            </div>
                                                ...
                                                <div class="col-md d-flex">
                                                    <div class="form-group p-4 border-0">
                                                        ...
                                                        <div class="form-field">
                                                            ...
                                                            <input type="text" class="form-control" name="search" placeholder="Search destination" value="{{ request('search') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md d-flex">
                                                    <div class="form-group p-4">
                                                        ...
                                                        <div class="form-field">
                                                            ...
                                                            <input type="date" class="form-control" name="departure_date" min="{{ date('Y-m-d') }}" value="{{ request('departure_date') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md d-flex">
                                                    <div class="form-group p-4">
                                                        ...
                                                        <div class="form-field">
                                                            <div class="icon"><span class="fa fa-calendar"></span></div>
                                                            <input type="date" class="form-control" name="return_date" min="{{ date('Y-m-d') }}" value="{{ request('return_date') }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md d-flex">
                                                ...
                                                <div class="col-md d-flex">
                                                    <div class="form-group d-flex w-100 border-0">
                                                        <div class="form-field w-100 align-items-center d-flex">
                                                            <input type="submit" value="Search" class="align-self-stretch form-control btn btn-orange">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                ...
                <div class="col-md-6">
                    <div class="row">
                        <div class="col-md-12 col-lg-6 d-flex align-self-stretch ftco-animate">
                            <div class="services services-1 color-1 d-block img" style="background-image: url('{{ asset('template/images/services-1.jpg') }}');">
                        ...
                        <div class="col-md-12 col-lg-6 d-flex align-self-stretch ftco-animate">
                            <div class="services services-1 color-2 d-block img" style="background-image: url('{{ asset('template/images/services-2.jpg') }}');">
                        ...
                        <div class="col-md-12 col-lg-6 d-flex align-self-stretch ftco-animate">
                            <div class="services services-1 color-3 d-block img" style="background-image: url('{{ asset('template/images/services-3.jpg') }}');">
                        ...
                        <div class="col-md-12 col-lg-6 d-flex align-self-stretch ftco-animate">
                            <div class="services services-1 color-4 d-block img" style="background-image: url('{{ asset('template/images/services-4.jpg') }}');">
                                ...
                                <div class="text-center">
                                    @auth
                                        <a href="{{ route('bookings.create', $destination->id) }}"
                                            class="btn btn-orange btn-book-now w-75 mt-3 py-2 rounded-pill shadow">
